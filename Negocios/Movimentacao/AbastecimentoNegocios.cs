...
namespace Negocios
{
    public class AbastecimentoNegocios
    {
        ...
        public ItensAbastecimentoCollection PesqItens(string tipo, string numeroRegiao, string numeroRua, string lado, string descCategoria, string codFornecedor, int[] codEstacao)
        {
            try
            {
                //Instância uma coleção de objêtos
                ...
                else if (tipo.Equals("FLOWRACK"))
                {
                    ...
                    {
                        select += "where s.sep_tipo = @tipo and s.est_codigo = " + codEstacao[0] + " ";
        ...
        public ItensAbastecimento PesqAbastecimentoPulmao(int idProduto, int pulaLinha, string empresa)
        {
            try
            {
                ...
                //String de consulta
                string select = "select first(1) skip @pulaLinha a.apa_codigo, a.apa_endereco, ar.prod_id, arm_quantidade/prod_fator_pulmao as estoque, arm_vencimento, arm_lote " +
