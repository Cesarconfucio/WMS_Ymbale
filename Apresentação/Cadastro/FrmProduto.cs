    ...
    public partial class FrmProduto : Form
    {
        ...
        private void txtPesqFornecedor_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.F2)
            {
                ...
                if (frameForn.ShowDialog() == System.Windows.Forms.DialogResult.OK)
                {
                    ...
                    txtPesqFornecedor.Text = frameForn.codFornecedor;
                    txtPesqNmFornecedor.Text = frameForn.nmFornecedor;
                }
            }
        }
        ...
        private void AlterarProduto()
        {
            try
            {
                ...
                else
                {
                    ...
                    //Altera 
                    produtoNegocios.Alterar(produto);
        ...
        private void PesqCodBarra()
        {
            try
            {
                ...
                ProdutoNegocios produtoNegocios = new ProdutoNegocios();
                //A coleção recebe o resultado da consulta
                barraCollection = produtoNegocios.PesqCodBarra(chkPesqAtivo.Checked);
