            ...
            try
            {
                ...
                else
                {
                    ...
                    if (opcao == true)
                    {
                        ...
                        produtoNegocios.SalvarCodBarra(idProduto, numeroBarra, multiplicador, altura, largura, comprimento, cubagem, peso);
                    }
                    else if (opcao == false)
                    {
                        //Altera as responsabilidades do empilhador
                        produtoNegocios.AlterarCodBarra(idProduto, codBarra, altura, largura, comprimento, cubagem, peso);
                    }
