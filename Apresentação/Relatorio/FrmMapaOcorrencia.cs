...
namespace Wms.Relatorio
{
    public partial class FrmMapaOcorrencia : Form
    {
        ...
        public void GerarRelatorio(string devolucao, string reentrega, string dataIncial, string dataFinal)
        {
            try
            {
                ...
                ocorrenciaCollection = ocorrenciaNegocios.ImpressaoOcorrencia(devolucao, reentrega, dataIncial, dataFinal);
