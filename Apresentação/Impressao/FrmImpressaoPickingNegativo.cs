...
{
    public partial class FrmImpressaoPickingNegativo : Form
    {
        //Array com id
        private int[] regiao;
        private int[] rua;
        ...
        public FrmImpressaoPickingNegativo()
        {
            InitializeComponent();
        }

        private void FrmImpressaoPickingNegativo_Load(object sender, EventArgs e)
        {
        ...
        {
            Relatorio.FrmPickingNegativo frame = new Relatorio.FrmPickingNegativo();
